# CIFAR100_coarse is adapted from torchvision's CIFAR dataset implementation:
# https://github.com/pytorch/vision/blob/v0.11.0/torchvision/datasets/cifar.py
# Copyright (c) Soumith Chintala 2016; BSD-3-Clause. See THIRD_PARTY_NOTICES.md.
